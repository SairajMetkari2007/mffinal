...
//fighter2.depth=fighter1.depth-1;
  ...
  fDodge=[fighter1DodgeImg,fighter2DodgeImg];
...
play(){
      ...
      healthbar[index-1].width=allPlayers[plr].width;    
        ...
        if (index === player.index){
          ...
          if (keyWentDown('l') ){
            ...
            fighter[index-1].addAnimation('fighter1',fDodge[index-1]);
           }         
          }
 ...
 if(allPlayers.player1.health <allPlayers.player2.health){
    ...
    image(f1WinsImg,70,200,displayWidth/4, displayHeight/9 + 100)
    image(image2die,70,200,displayWidth/4+550, displayHeight/9 + 100)
 }
 else{
 fill("red");
 text(allPlayers.player2.name+" Wins",displayWidth/4, displayHeight/9 + 79)
 image(f2WinsImg,70,200,displayWidth/4, displayHeight/9 + 100)
